...
const Page = () => {
    return (
        <div className={'w-full h-full flex flex-col gap-4'}>
            ...
            {/*</div>*/}
            <Image src={corporateSolutionsBanner} alt={'banner'} style={{ width: '100%', height: '40%', objectFit: 'cover' }} />
            <div className="container mx-auto px-5 flex flex-col gap-3 mt-6">
                <h2 className={'text-3xl font-semibold text-center'}>Kurumsal Çözümler</h2>
